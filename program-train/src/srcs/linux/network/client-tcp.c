 ...
 * Last modified: 2016-10-30 14:24:31
...
int client_tcp_main(int argc, char **argv)
{
    ...
    {
#if 1
        int client_tcp_half_close(int argc, char **argv);
        ret = client_tcp_half_close(argc, argv);
#endif
    }
...
int client_tcp_half_close(int argc, char **argv)
{
    ...
    int read_len = read(sock, message, sizeof(message)-1);
    message[read_len] = '\0';
    printf("shutdown read : %s\n", message);
